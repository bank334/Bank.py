...
ki2 = LINETCR.LINE() 
ki2.login(token="EpJzt5XTOljRBJevbIh8.ghZnmC2ciegQIghsMM2+ka.5jB0JPrwkjx4bfgQdGMQ+TJtkU0+PnlugXvj0dhlHRI=")
print "ki2 login success"

ki3 = LINETCR.LINE() 
ki3.login(token="EpEHGbsu7KSK8nwSKj0e.VaiImiEjGvzw9+FPEujUpG.NrMr9K2mT2rc4nFj+WiVN63bJkAVobcGhBoLVWWwL+I=")
print "ki3 login success"

ki4 = LINETCR.LINE() 
ki4.login(token="EpJCkxL4RHLn2TXRcDSf.ErORVM2uZkxL3DKI0dXZpW.gQ0590ki/meOdHPsE4HIFToh+r75ZI+YaHtqhON0/54=")
print "ki4 login success"

ki5 = LINETCR.LINE() 
ki5.login(token="Ep0PgBmb6vshLHO1iNI7.7xZurXNCqndHG6OfwUrtzW.rWjye7+Z5caG9dFRWpFEL9nJMgcRFJpayG9gZeE6QvI=")
print "ki5 login success"

ki6 = LINETCR.LINE() 
ki6.login(token="Ep3zo4WjgK9c1lCHHFh6.alc3n8osAFS/h7CZtZCrzG.V1yHEClOf+F0aUY6mRPvdWAG3lbQ/5Ean8l0Vp1W+vM=")
...
mid = cl.getProfile().mid
Bots = ["ue0d25974d7242e56c49ad1d2e5b118e4","ud349eaafe39088bdbb384d1cfa6c38a9","u00b0b737c39269fb3e1fb7334f371166","u3c879b92e0f64b32936026ed5e2dba79","ub97e7a4024fd8f2576755420c9861a67","udf9c7f239408254bf2c60456ee47bb49","u65437c1fb469a5d7020b1a72ca1c5d89"]
...
wait = {
    ...
    "pname":{},
    "pro_name":{},
    "tag1":"แท็คขนาดนี้ มีอะไรเร่งด่วนโทรมาเลยนะครับผม ?",
            ...
            if msg.contentType == 13:
                if wait["wblack"] == True:
                    ...
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        cl.sendText(msg.to,"ᴅᴇʟᴇᴛᴇ ʙʟᴀ���ᴋʟɪsᴛ ᴄᴏᴍᴘʟᴇᴛᴇ")
                        wait["dblack"] = False
                    else:
                        wait["dblack"] = False
...
#======================================================#
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Invite Protect Enable 􀜁����􏿿👈")
                    else:
                        cl.sendText(msg.to,"Hal ini sudah terbuka ô€¨👈")
                else:
...
#======================================================#
                ...
                cl.sendText(msg.to," มีอะไรครับ ตาต้อมเลิกขายบอทละครับผม")
...
#===============================================
                ...
                cl.sendText(msg.to,X)
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Lurking dulu dudul Baru bilang result Point.\nคุณยังไม่ได้คั้งค่าเริ่มต้นการอ่าน โปรดตั้งค่าเริ่มต้นด้วยการพิมพ���  .11 เพื่อเริ่มการอ่าน")
