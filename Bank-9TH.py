...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"[B̲̲̅̅a̲̲̅̅n̲̲̅̅k̲̲̅ ̲̲̅ʙ̲̲̅̅ᴏ̲̲̅̅ᴛ̲̲̅̅ ̲̲̅̅&̲̲̅̅ ̲̲̅̅L̲̲̅̅i̲̲̅n̲̲̅̅e̲̲̲̅̅̅]   /n ✨ชื่อแบงค์ครับยินดีที่ได้รู้จัก✨",
    "lang":"JP",
    "comment":"[B̲̲̅̅a̲̲̅̅n̲̲̅̅k̲̲̅ ̲̲̅ʙ̲̲̅̅ᴏ̲̲̅̅ᴛ̲̲̅̅ ̲̲̅̅&̲̲̅̅ ̲̲̅̅L̲̲̅̅i̲̲̅n̲̲̅̅e̲̲̲̅̅̅]   /n ✨ชื่อแบงค์ครับยินดีที่ได้รู้จัก✨",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
              ...
              if msg.from_ in admin: 
                ...
                hi.sendText(msg.to, "%s Detik" % (elapsed_time))
                ...
                kg.sendText(msg.to, "%s Detik" % (elapsed_time))
                kh.sendText(msg.to, "%s Detik" % (elapsed_time))
                kj.sendText(msg.to, "%s Detik" % (elapsed_tim
#------------------------------------------------------------------
            elif msg.text in ["Ban"]:
              if msg.from_ in admin: 
