...
〘Cbc Text〙
〘Gbc Text〙
〘Getbio @〙 เอาเสตตัสเพื่อน
〘Getinfo @〙เอาสถานะเพื่อน
〘Getname @〙เอาชื่อเพื่อน
〘Getprofile @〙เอาโปรไฟล์เพื่อน
...
Respon〙  เทสบอท
Runtime〙 เทสเวลา
Kapten copy @〙 เซลบอทก๊อฟปี้
TC1 copy @ คิกเก้อ1 ก๊อฟปี้
TC2 copy @〙 คิกเก้อ2 ก๊อฟปี้
TC3 copy @〙 คิกเก้อ3 ก๊อฟปี้
TC4 copy @〙 คิกเก้อ4 ก๊อฟปี้
Backup all〙 กลับร่างเดิมทั้งหมด
/bio Text〙
...
#                cl.sendText(msg.to,"╔════════���════════════════\n""║           ☆☞ S T A T U S ☜☆\n""╠═════════════════════════\n"+md+"╚═════════════════════════")
		...
		if wait["Notifed"] == True: md+="􀬁􀆐􏿿 Notifed : on ����􀄯􏿿\n"
...
#----------------------------------------------------------
 ...
 #               if wait["lang"] == "JP":
 #                  ki6.sendText(msg.to,"ลบห้องเชิญเร���ยบร้อ���แล้ว")
 #               else:
